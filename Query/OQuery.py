...
if __name__ == '__main__':
    ...
    read_directory = root_directory + u'dataset/batch_data_segment/topics_data1'
    ...
    select = 30
    print time_interval
    write_filename = write_directory + u'/q1.txt'
    
    oquery(keyword_list, mode, time_interval, select, read_directory, write_filename)
